...
class Messages:
    ...
    def game_over_name(self,player):
        ...
        screen.blit(text, (left_margin + 9 * block_size, upper_margin - 3* block_size))
    ...
    def shoot_text_delete(self,shift):
        pygame.draw.rect(screen, BLACK, ((left_margin + shift , upper_margin - 3 * block_size), (block_size * 11.5, block_size)))
